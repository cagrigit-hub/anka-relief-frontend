    ...
    <div className='relative mb-24' id="qa">
      <div className='absolute h-[10rem] w-full' style={{
        ...
        <div className='px-12 md:p-0 md:max-w-7xl pt-[11rem] mx-auto w-full '>
          ...
          <div className='flex flex-col md:flex-row relative space-x-0 md:space-x-12'>
            <div>
              {
